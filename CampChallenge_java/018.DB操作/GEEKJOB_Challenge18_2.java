 ...
 * @author guest1Day
 */
public class GEEKJOB_Challenge18_2 extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                try {
                    ...
                    //  データベースに入力する情報を設定
                    String sql = "INSERT INTO profiles VALUES(6, '高田 博', '090-1100-5678', 34, '1983-10-30')";
                    ...
                    out.println("データベースに情報を入力しました。<br>");
