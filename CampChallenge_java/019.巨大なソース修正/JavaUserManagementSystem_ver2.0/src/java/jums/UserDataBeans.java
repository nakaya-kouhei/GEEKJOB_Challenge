...
public class UserDataBeans implements Serializable{
    ...
    public void setUserDataBeans(UserDataDTO udd){
        this.setName(String.valueOf(udd.getName()));
        String y = new SimpleDateFormat("yyyy").format(udd.getBirthday());
        this.setYear(y);
        String m = new SimpleDateFormat("MM").format(udd.getBirthday());
        this.setMonth(m);
        String d = new SimpleDateFormat("dd").format(udd.getBirthday());
        this.setDay(d);
        this.setType(String.valueOf(udd.getType()));
        this.setTell(String.valueOf(udd.getTell()));
        this.setComment(String.valueOf(udd.getComment()));
    }
